...
public class CheckoutPage {
	...
	private WebElement chkbx_ShipToDifferentAddres;
	...
	public void check_ShipToDifferentAddress(boolean value) {
		...
		if (!value) {			
			chkbx_ShipToDifferentAddres.click();
		}
		//Deal with Ajax
		Wait.untilJQueryLoadDone(driver);
	}
	...
	public void select_PaymentMethod(String paymentMethod) {
		if (paymentMethod.equals("CheckPayment")) {
			...
			new Exception("Payment Method not recogised " + paymentMethod);
		}
	...
	public void fill_PersonDetails(Customer customer) {
		...
		enter_City(customer.address.county);
